...
TextToSpeech tts;
    ...
    private static final String URL="https://wizzie.online/Email/add_favourite.php";
    private static final String URLD="https://wizzie.online/Email/add_delete.php";
    private static final String URL1="https://wizzie.online/Email/add_delete.php";
...
holder.subject.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        tts.speak(data.get(position).toString(),TextToSpeech.QUEUE_FLUSH,null,null);
    }
});
